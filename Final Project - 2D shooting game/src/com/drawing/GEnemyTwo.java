...
public class GEnemyTwo implements GShape {
	...
	GEnemyTwo(final GL2 gl, int x, int y, long interval, float w, float h) {
	...
	public float[] getEnemyPosition(){
		...
		int rightCorrection = 20;
		int leftCorrection = 35;
		
		if(this.spriteDirection == true)
		{
			position[0] = this.movX+rightCorrection;
			position[1] = this.movY+leftCorrection;
		}
		else
		{
			position[0] = this.movX-rightCorrection;
