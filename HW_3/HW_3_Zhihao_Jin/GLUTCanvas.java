...
class GLUTCanvas extends GLCanvas implements GLEventListener {
	...
	private GUFO myUFO;
	private GMissile myMissile;
	private GWindmill myWindwill;
	...
	public void init(GLAutoDrawable drawable) {
		...
		//MyfirstCloud
		vertex2f = new float[] {50.0f, 90.0f, 5.0f, 5.0f, 0.25f};
		myFirstCloud = new GCloud(vertex2f);
		
		//MySecondCloud
		vertex2f = new float[] {70.0f, 87.0f, 4.5f, 5.0f, 0.3f};
		...
		//myUFO
		myUFO = new GUFO(60.0f, 90.0f);
		
		//myMissile
		myMissile = new GMissile(75.0f, 90.0f);
		
		//myWindwill
		myWindwill = new GWindmill(70.0f, 70.0f);
